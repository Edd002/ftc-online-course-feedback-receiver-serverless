...
import com.fiap.tech.challenge.online.course.feedback.receiver.serverless.request.LoginRequest;
import com.fiap.tech.challenge.online.course.feedback.receiver.serverless.response.LoginResponse;
...
public class FTCOnlineCourseFeedbackReceiverServerlessHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        try {
            logger.log("Request received on - FTC Online Course Feedback Receiver - Payload: " + request.getBody());
