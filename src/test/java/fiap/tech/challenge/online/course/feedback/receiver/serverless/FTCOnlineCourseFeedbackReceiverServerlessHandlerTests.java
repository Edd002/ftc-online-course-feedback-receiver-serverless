...
class FTCOnlineCourseFeedbackReceiverServerlessHandlerTests {
    ...
    void handleRequest_RegisterFeedbackSuccess() {
        ...
        request.setPath("/");
        request.setBody(HttpObjectMapper.writeValueAsString(new FeedbackRequest(UserType.TEACHER, "teacher1@email.com", "123", "student1@email.com", "Nome Assessment 4", AssessmentType.TEST, 5.0, false, "Descrição Assessment 4", "Comentário Assessment 4")));
